...
#[ORM\Entity(repositoryClass: TripleImageBlockRepository::class)]
#[Vich\Uploadable]
class TripleImageBlock
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\Column(length: 255)]
    private ?string $template = "triple-image";

    #[ORM\Column(length: 255)]
    private ?string $name = "Trois images";
    ...
    public function getBlockType(): string {
        return TripleImageBlockType::class;
    }
    ...
    public function setUpdatedAt(\DateTimeImmutable $date): TripleImageBlock
    {
        $this->updatedAt = $date;
        return $this;
    }
