...
#[ORM\Entity(repositoryClass: DualImageBlockRepository::class)]
#[Vich\Uploadable]
class DualImageBlock
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\Column(length: 255)]
    private ?string $template = "dual-image";

    #[ORM\Column(length: 255)]
    private ?string $name = "Deux images";

    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'dual_image_block', fileNameProperty: 'image1', size: 'imageSize1')]
    ...
    public function getBlockType(): string {
        return DualImageBlockType::class;
    }
    ...
    public function setUpdatedAt(\DateTimeImmutable $date): DualImageBlock
    {
        $this->updatedAt = $date;
        return $this;
    }
