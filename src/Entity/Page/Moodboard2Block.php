...
#[ORM\Entity(repositoryClass: Moodboard2BlockRepository::class)]
#[Vich\Uploadable]
class Moodboard2Block
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?string $template = "moodboard-2";

    #[ORM\Column(length: 255)]
    private ?string $name = "Moodboard 2";
    ...
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image1', size: 'imageSize1')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image2', size: 'imageSize2')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image3', size: 'imageSize3')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image4', size: 'imageSize4')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image5', size: 'imageSize5')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image6', size: 'imageSize6')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image7', size: 'imageSize7')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image8', size: 'imageSize8')]
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property.
    #[Vich\UploadableField(mapping: 'moodboard_2_block', fileNameProperty: 'image9', size: 'imageSize9')]
    ...
    public function getBlockType(): string {
        return Moodboard2BlockType::class;
    }
    ...
    public function setUpdatedAt(\DateTimeImmutable $date): Moodboard2Block
    {
        $this->updatedAt = $date;
        return $this;
    }
